    ...
    <section id="about" className="py-20 bg-gradient-to-b from-background to-muted/20">
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-primary/10 to-accent/10 p-8 rounded-2xl">
              <div className="bg-card p-8 rounded-xl shadow-xl">
                <h3 className="text-2xl font-bold mb-4 text-primary">Our Origin & Growth</h3>
          ...
          {/* Right: Text Content */}
          <div>
            <h3 className="text-3xl font-bold mb-6">Academic Distinction</h3>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {highlights.map((item, index) => (
            <Card
              key={index}
              className="p-6 text-center hover:shadow-xl transition-all hover:scale-105 border-2 border-transparent hover:border-primary"
            >
